        ...
        switch(*choix)
        {
            case 1 ://Génération de l'instance Im
                do
                {
                   ...
                   if(*m>=300)
                   {
                       printf("Pour une instance Im, veuillez saisir un nombre de machine inferieur à 300. Sinon, temps trop long");
                   }
            ...
            case 2 ://Génération de l'instance I'm
                ...
                scanf("%d", m);
                break;
            case 3 ://Génération des instances IR
                printf("Saisissez le nombre de machine m : ");
                scanf("%d", m);
...
void generationIR(int *D, int n, int min,int max)
{
    ...
    for(i=0; i<n; i++)//On attribue des durées aléatoires à notre instance
    {
